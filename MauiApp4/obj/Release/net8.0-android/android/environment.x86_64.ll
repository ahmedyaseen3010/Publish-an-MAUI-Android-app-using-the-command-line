...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-MauiApp4.dll.so
		ptr null; void* handle (0x0)
	}, ; 24
	%struct.DSOCacheEntry {
...
@.env.3 = private unnamed_addr constant [37 x i8] c"a1d055d6-9880-4eee-8b40-bfe7939e7e7e\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [23 x i8] c"libaot-MauiApp4.dll.so\00", align 16
